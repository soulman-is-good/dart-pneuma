...
class Response {
  ...
  set deadline(Duration dl) {
    _res.deadline = dl;
  }

  Future<Socket> detachSocket({bool writeHeaders = true}) =>
      _res.detachSocket(writeHeaders: writeHeaders);
  ...
  set persistentConnection(bool pc) {
    _res.persistentConnection = pc;
  }
  ...
  void writeAll(Iterable<dynamic> objects, [String separator = ""]) =>
      _res.writeAll(objects, separator);
